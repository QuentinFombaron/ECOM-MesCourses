...
class CourseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Course entity")
        ...
        .repeat(2) {
            ...
            .post("/api/courses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "organisateur":"0", "titre":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "sport":null, "date":"2020-01-01T00:00:00.000Z", "heure":"SAMPLE_TEXT", "longitude":null, "latitude":null, "lieu":"SAMPLE_TEXT", "prix":null, "image1":null, "image2":null, "image3":null, "image4":null, "image5":null}""")).asJSON
            .check(status.is(201))
