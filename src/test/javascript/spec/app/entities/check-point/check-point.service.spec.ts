...
describe('Service Tests', () => {
    describe('CheckPoint Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CheckPointService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/check-points';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CheckPoint', () => {
                service.create(new CheckPoint(null)).subscribe(received => {
            ...
            it('should update a CheckPoint', () => {
                service.update(new CheckPoint(123)).subscribe(received => {
