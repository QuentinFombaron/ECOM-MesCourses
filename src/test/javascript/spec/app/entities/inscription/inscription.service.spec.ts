    ...
    describe('Inscription Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Inscription', () => {
                service.create(new Inscription(null)).subscribe(received => {
            ...
            it('should update a Inscription', () => {
                service.update(new Inscription(123)).subscribe(received => {
            ...
            it('should return a Inscription', () => {
